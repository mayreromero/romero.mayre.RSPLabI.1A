    ...
    if(this!=NULL && nodeIndex>=0 && nodeIndex<=ll_len(this))
    {
        ...
        if(nuevoNode!=NULL)
        {
            ...
            if(nodeIndex==0)
            {
                ...
                nuevoNode->pNextNode=getNode(this,0);
...
int ll_clear(LinkedList* this)
{
    ...
    if(this!=NULL)
    {
        ...
        while(ll_len(this))//ll_len(this)!=0
        {
            ll_remove(this,0);
            returnAux=0;
        }
...
{
    int returnAux = -1;
    if(!ll_clear(this))//ll_clear(this)==0
    {
        free(this);
        returnAux=0;
    }
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this!=NULL && this2!=NULL)
    {
        ...
        for(int i=0; i<tam; i++)
        {
            ...
            if(!ll_contains(this,elemento))//if(ll_contains(this,elemento)==1)
            {
                returnAux=0;
                break;
            }
...
{
    LinkedList* listaFiltrada2=NULL;
    void* auxElement=NULL;
    if(this!=NULL && pFunc!=NULL)
    {
        listaFiltrada2=ll_newLinkedList();
        if(listaFiltrada2!=NULL)
        {
            for(int i=0; i<ll_len(this); i++)
            {
                ...
                if(pFunc(auxElement))
                {
                    ll_add(listaFiltrada2,auxElement);
                }
            }
            ...
            for(int i=0; i<ll_len(this); i++)
                {
                    auxElement=ll_get(this,i);
                    pFunc(auxElement);
                    ll_add(listaTiempos,auxElement);
                }
        }
    }
